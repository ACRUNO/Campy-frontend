...
export function getProvincias(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function getAllLocalidades(
  id: number
...
export function getCampingsProvincias(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function getCampingsLocalidades(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function getAllCampings(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function filterProvincia(
  id: number
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
...
export function filterLocalidad(
  id: number
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
...
export function getPeriodoAgua(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function filterPeriodoAgua(
  id: number
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
...
export function getPeriodoAbierto(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function filterPeriodoAbierto(
  id: number
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
...
export function getAllCategorias(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function getCampings_dash(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function habilitacion_camping(
  id: number,
  habilitacion: number,
  { token }: { token: string }
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
      var json = await axios.put(
        `/api/campings/habilitacion/${id}?habilitar=${habilitacion}`,
        {},
...
export function getUsuarios_dash(): ThunkAction<
  void,
  RootState,
  unknown,
  AnyAction
...
export function habilitacion_usuario(
  id: number,
  habilitacion: number,
  { token }: { token: string }
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
      var json = await axios.put(
        `/api/usuarios/deshabilitar/${id}?habilitar=${habilitacion}`,
        {},
        { headers: { authorization: token } }
      );
...
export function tipo_usuario(
  id: number,
  { token, userType }: { token: string; userType: string },
  callbackGetuserDash: () => void
): ThunkAction<void, RootState, unknown, AnyAction> {
  return async function (dispatch: AppDispatch) {
    try {
      var json = await axios.put(
...
export function filtrosPrincipales(
  provincia: number,
  localidad: number,
...
export function setCardInfo(
  ...
  let info = {
    ...
    imagenes: img[0],
    descripcion_camping: desc_camping,
  };
  return {
    type: SET_CARD_INFO,
    payload: info,
...
export function setdetailreserv(
  day1: number,
  alldate: string,
  day2: number,
  alldate2: string,
