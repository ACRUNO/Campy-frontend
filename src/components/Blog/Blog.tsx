    ...
    <React.Fragment>
      <Container maxWidth={false} sx={{bgcolor: 'rgb(245, 245, 245)'}}>
        <main>
          ...
          <Grid container display="flex" flexDirection="column" alignContent="space-around" sx={{mb:2, backgroundColor:'#273115', color:"#A4BE7B"}}>
          <Typography component="h2" variant="h4" sx={{mb:2, pl:1, pt:2}}>Lo más comentado</Typography>
          ...
          <Grid container display="flex" flexDirection="column" alignContent="space-around" sx={{mb:2, backgroundColor:'#D8E3C5', borderStyle:"double", borderColor:"#273115"}}>
            <Typography component="h2" variant="h4" sx={{mb:2, pl:1, pt:2}}>Lo más visto</Typography>
            <Grid container spacing={2} display="flex" flexDirection="row" alignContent="center" sx={{pb:4, pl:1, pr: 1}} >
