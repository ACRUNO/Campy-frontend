    ...
    <React.Fragment>
      <ThemeProvider theme={theme}>
        ...
        <Routes>
          ...
          <Route path="/create" element={user ? <CreateCamping preInputValues={null} /> : <Loader open={true} ></Loader>} />
          <Route path="/update" element={user ? <UpdateCamping /> : <Loader open={true} ></Loader>} />
          <Route path="/about" />
